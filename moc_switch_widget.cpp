/****************************************************************************
** Meta object code from reading C++ file 'switch_widget.h'
**
...
#error "The header file 'switch_widget.h' doesn't include <QObject>."
...
void SwitchControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SwitchControl::toggled)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SwitchControl::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SwitchControl.data,
