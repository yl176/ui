#ifndef ROOM_BACK_WINGET_H
#define ROOM_BACK_WINGET_H
...
*/
class RoomBackWidget : public QWidget
{
    Q_OBJECT

public:
    explicit RoomBackWidget(QWidget *parent = 0);
	//void setTranslator(QTranslator* translator);
	void translateLanguage();
	void showTheRoom(int index, QString room_name);
...
private:
	...
	int language_flag = 0;
    QString skin_name;
	QPushButton *return_name_button;
...
public slots:
	...
	//void showWidget();
    void return_room_slot();
	
signals:
	void return_room_singal();
